def config_parser():
    ...
    parser.add_argument("--b2b", type=float, default=0, help="back_to_back")
    ...
    parser.add_argument("--center_mask_enable", type=int, default=0, help="enable center circular mask (crop to center region)")
    parser.add_argument("--center_mask_size", type=int, default=200, help="diameter of center mask in pixels")
    ...
    parser.add_argument('--n_b', type=float, default=1.33, help='Base index')
